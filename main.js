...
/* loads the audio elements for each beat */
function loadBeats() {
	/*
	document.getElementById("audio052").load();
	document.getElementById("audio048").load();
	document.getElementById("audio046").load();
	document.getElementById("audio043").load();
	document.getElementById("audio042").load();
	document.getElementById("audio040").load();
	document.getElementById("audio039").load();
	document.getElementById("audio038").load();
	document.getElementById("audio037").load();
	document.getElementById("audio035").load();
	document.getElementById("audio033").load();
	document.getElementById("audio032").load();
	document.getElementById("audio031").load();
	document.getElementById("audio030").load();
	document.getElementById("audio028").load();
	document.getElementById("audio027").load();
	document.getElementById("audio025").load();
	document.getElementById("audio024").load();
	document.getElementById("audio022").load();
	document.getElementById("audio021").load();
	document.getElementById("audio020").load();
	document.getElementById("audio018").load();
	document.getElementById("audio016").load();
	document.getElementById("audio013").load();
	document.getElementById("audio009").load();
	document.getElementById("audio006").load();
	document.getElementById("audio004").load();
	*/
}
...
/*
let beatLength = $(".beat-wrap").length;
let beatNumero = 0;
async function showBeat(i) {
	$(".beat-wrap").eq(i).show();
	$(".beat-wrap").eq(i).next().show();	
}

async function showBeats() {
	showBeat(beatNumero);
	await showBeat();
	if (beatNumero < beatLength) {
		setTimeout(() => {
			beatNumero++;
			showBeats();
		}, 200);
